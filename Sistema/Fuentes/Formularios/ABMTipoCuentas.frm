...
Begin VB.Form ABMTipoCuentas 
   ...
   Begin VB.CommandButton cmdAyuda 
      Height          =   315
      Left            =   210
      Picture         =   "ABMTipoCuentas.frx":000C
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   1605
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "ABMTipoCuentas"
...
Const cTabla = "TIPO_CUENTA"
Const cCampoID = "TCU_CODIGO"
Const cDesRegistro = "Cuentas"
...
Function SetMode(pMode As Integer)
    ...
    Select Case pMode
        Case 1
            ...
            Me.Caption = "Nueva Cuenta..."
            AcCtrl txtID
        Case 2
            cmdAceptar.Enabled = False
            Me.Caption = "Editando Cuenta..."
            DesacCtrl txtID
        Case 3
            cmdAceptar.Visible = False
            Me.Caption = "Datos de la Cuenta..."
            DesacCtrl txtID
        Case 4
            cmdAceptar.Enabled = True
            Me.Caption = "Eliminando Cuenta..."
            DesacCtrl txtID
    End Select
    ...
    If pMode <> 4 Then
        ...
        If txtID.Text = "" Then
            ...
            MsgBox "Falta información." & Chr(13) & _
                             "Ingrese la Identificación de la Cuenta antes de aceptar.", vbCritical + vbOKOnly, App.Title
            txtID.SetFocus
            Exit Function
        ElseIf txtDescri.Text = "" Then
            Beep
            MsgBox "Falta información." & Chr(13) & _
                             "Ingrese la descripción de Cuenta antes de aceptar.", vbCritical + vbOKOnly, App.Title
            txtDescri.SetFocus
            Exit Function
        End If
    End If
    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            Case 1 'nuevo
                ...
                cSQL = cSQL & "     (TCU_CODIGO, TCU_DESCRI) "
                cSQL = cSQL & "VALUES "
            ...
            Case 2 'editar
                ...
                cSQL = cSQL & "     TCU_DESCRI = " & XS(txtDescri.Text)
                cSQL = cSQL & " WHERE TCU_CODIGO  = " & txtID.Text
            
            Case 4 'eliminar
            
                cSQL = "DELETE FROM " & cTabla & " WHERE TCU_CODIGO  = " & txtID.Text
...
Private Sub Form_Load()
    ...
    If vMode <> 1 Then
        If vFieldID <> "0" Then
            cSQL = "SELECT * FROM " & cTabla & "  WHERE TCU_CODIGO = " & Mid(vFieldID, 2, Len(vFieldID) - 2)
            rec.Open cSQL, DBConn, adOpenStatic, adLockOptimistic
            If (rec.BOF And rec.EOF) = 0 Then
                'si encontró el registro muestro los datos
                txtID.Text = rec!TCU_CODIGO
                txtDescri.Text = rec!TCU_DESCRI
            Else
                Beep

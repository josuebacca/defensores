...
Begin VB.Form ABMEstadoDocumento 
   ...
   Caption         =   "Datos de Estado Documento"
   ClientHeight    =   2025
   ClientLeft      =   2700
   ClientTop       =   2625
   ClientWidth     =   4530
   ...
   EndProperty
   Icon            =   "ABMEstadoDocumento.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdAyuda 
      Height          =   315
      Left            =   210
      Picture         =   "ABMEstadoDocumento.frx":000C
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   1605
      Width           =   330
...
Const cTabla = "ESTADO_DOCUMENTO"
Const cCampoID = "EST_CODIGO"
Const cDesRegistro = "Estado Documento"
    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            ...
            Case 2 'editar
                ...
                cSQL = cSQL & "     EST_DESCRI = " & XS(txtDescri.Text)

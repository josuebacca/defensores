    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            Case 1 'nuevo
                ...
                cSQL = cSQL & "     (LOC_CODIGO, LOC_DESCRI) "
                cSQL = cSQL & "VALUES "
            ...
            Case 2 'editar
                ...
                cSQL = cSQL & "     LOC_DESCRI = " & XS(txtDescri.Text, True)
    ...
    If vMode <> 1 Then
        If vFieldID <> "0" Then
            ...
            If (rec.BOF And rec.EOF) = 0 Then
                ...
                txtDescri.Text = Trim(ChkNull(rec!LOC_DESCRI))
            Else
                Beep

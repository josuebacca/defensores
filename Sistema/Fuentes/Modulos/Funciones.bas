...
Public Function SacoAcento(Nombre As String) As String
    If InStr(1, Nombre, "Á") > 0 Then
        If InStr(1, Nombre, "Á") = 1 Then
            Nombre = "A" & Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "Á") - 1) & "A" & Mid(Nombre, InStr(1, Nombre, "Á") + 1)
        End If
    End If
    
    If InStr(1, Nombre, "É") > 0 Then
        If InStr(1, Nombre, "É") = 1 Then
            Nombre = "E" & Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "É") - 1) & "E" & Mid(Nombre, InStr(1, Nombre, "É") + 1)
        End If
    End If
    
    If InStr(1, Nombre, "Í") > 0 Then
        If InStr(1, Nombre, "Í") = 1 Then
            Nombre = "I" & Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "Í") - 1) & "I" & Mid(Nombre, InStr(1, Nombre, "Í") + 1)
        End If
    End If
    
    If InStr(1, Nombre, "Ó") > 0 Then
        If InStr(1, Nombre, "Ó") = 1 Then
            Nombre = "O" & Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "Ó") - 1) & "O" & Mid(Nombre, InStr(1, Nombre, "Ó") + 1)
        End If
    End If
    
    If InStr(1, Nombre, "Ú") > 0 Then
        If InStr(1, Nombre, "Ú") = 1 Then
            Nombre = "U" & Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "Ú") - 1) & "U" & Mid(Nombre, InStr(1, Nombre, "Ú") + 1)
        End If
    End If
    
    If InStr(1, Nombre, "Ñ") > 0 Then
        If InStr(1, Nombre, "Ñ") = 1 Then
            Nombre = "#" & Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "Ñ") - 1) & "#" & Mid(Nombre, InStr(1, Nombre, "Ñ") + 1)
        End If
    End If
    ...
    If InStr(1, Nombre, "ü") > 0 Then
        If InStr(1, Nombre, "ü") = 1 Then
            Nombre = "u" & Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "ü") - 1) & "u" & Mid(Nombre, InStr(1, Nombre, "ü") + 1)
        End If
    End If
    ...
    If InStr(1, Nombre, "º") > 0 Then
        If InStr(1, Nombre, "º") = 1 Then
            Nombre = Mid(Nombre, 2)
        Else
            Nombre = Mid(Nombre, 1, InStr(1, Nombre, "º") - 1) & " " & Mid(Nombre, InStr(1, Nombre, "º") + 1)
        End If
    End If
    SacoAcento = Nombre
End Function

Function CargarControlItemdata(ByRef pControl As Control, ByVal pSQL As String) As Boolean

    'Carga un control de tipo ComboBox o ListBox a partir del parametro pSQL
    'Parametros: pControl es el control que será cargado
    '                         pSQL es el query SQL a utilizar para cargar el control
    
    Dim cSQL As String
    Dim Rec As ADODB.Recordset
    Set Rec = New ADODB.Recordset
    
    CargarControlItemdata = False
    If TypeOf pControl Is ComboBox Or TypeOf pControl Is ListBox Then
        
        pControl.Clear
        Rec.Open pSQL, DBConn, adOpenStatic, adLockOptimistic
        If Rec.EOF = False Then
            Do While Rec.EOF = False
                pControl.AddItem Trim(Rec.Fields(1))
                pControl.ItemData(pControl.NewIndex) = Trim(Rec.Fields(0))
                Rec.MoveNext
            Loop
        End If
        Rec.Close
        CargarControlItemdata = True
    End If
End Function
